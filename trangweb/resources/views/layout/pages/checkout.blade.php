						...
						<div class="your-order-body" style="padding: 0px 10px">
							<div class="your-order-item">
								<div>
									...
									<div class="media">
										<img width="25%" src="public/source/image/product/{{$product['item']['image']}}" alt="" class="pull-left">
										<div class="media-body">
											<p class="font-large">{{$product['item']['name']}}</p>
											<span class="color-gray your-order-info">Color: Red</span>
											<span class="color-gray your-order-info">Size: M</span>
											<span class="color-gray your-order-info">Quantity:{{number_format($totalQty)}}
											</span>
							...
							<div class="your-order-item">
								...
								<div class="pull-right"><h5 class="color-black"> <span class="cart-total-value" value="@if(Session::has('cart')){{($totalPrice)}}@else 0 @endif">@if(Session::has('cart')){{number_format($totalPrice)}}@else 0 @endif đồng </span></h5></div>
								<div class="clearfix"></div>
							</div>
						</div>
